...
$IPBHTML = "";
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "".$this->__f__90500f476df632b7749b4fdd8f91508d($articles)."";
return $IPBHTML;
}


function __f__90500f476df632b7749b4fdd8f91508d($articles)
{
	$_ips___x_retval = '';
...
$IPBHTML .= "<div class='general_box'>
	...
	<ul class='hfeed'>
				".$this->__f__016ca8d1b12eeb7a9a2a1b6f8006bbb8($posts)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__016ca8d1b12eeb7a9a2a1b6f8006bbb8($posts=array())
{
	$_ips___x_retval = '';
...
$IPBHTML .= "<div class='general_box'>
	...
	<ul>
		".$this->__f__fa806336181067d4d72865783c053020($links)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__fa806336181067d4d72865783c053020($links=array())
{
	$_ips___x_retval = '';
