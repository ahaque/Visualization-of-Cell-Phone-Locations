	...
	<div class='post_form'>
		...
		" . (($custom_fields != '') ? ("<fieldset class='row1'>
				...
				" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
					".$this->__f__51b3c764e53017a8edb33668b721761a($mid,$key,$custom_fields,$errors,$reg)."				") : ("")) . "
				
				" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
					".$this->__f__af9bfdcedc02805a85b1553699eb672c($mid,$key,$custom_fields,$errors,$reg)."				") : ("")) . "
			</fieldset>") : ("")) . "
...
function __f__51b3c764e53017a8edb33668b721761a($mid="",$key="",$custom_fields="",$errors="", $reg="")
{
	$_ips___x_retval = '';
...
function __f__af9bfdcedc02805a85b1553699eb672c($mid="",$key="",$custom_fields="",$errors="", $reg="")
{
	$_ips___x_retval = '';
		...
		<fieldset class='general_box'>
			<h3>{$this->lang->words['coppa_info']}</h3>
				...
				<select name='m' class='input_select'>
			 		...
			 		".$this->__f__6953cbec2fa03ad2300c75a28a7e1ac3()."				</select>
	
				<select name='d' class='input_select'>
			 		<option value='0'>{$this->lang->words['select_day']}</option>
			 		".$this->__f__ce3013f8f8b46832c4a6c8fcb49232d1()."				</select>
	
				<select name='y' class='input_select'>
			 		<option value='0'>{$this->lang->words['select_year']}</option>
			 		".$this->__f__d1fa71e24721d545c44257159c411099()."				</select>
		</fieldset>
		<fieldset class='submit'>
			<input type='submit' value='{$this->lang->words['coppa_continue_button']}' class='input_submit' /> {$this->lang->words['or']} <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "", 'public','' ), "", "" ) . "' title='{$this->lang->words['cancel']}' class='cancel'>{$this->lang->words['cancel']}</a>
		</fieldset>
	</div>
</form>";
return $IPBHTML;
...
function __f__6953cbec2fa03ad2300c75a28a7e1ac3()
{
	$_ips___x_retval = '';
...
function __f__ce3013f8f8b46832c4a6c8fcb49232d1()
{
	$_ips___x_retval = '';
...
function __f__d1fa71e24721d545c44257159c411099()
{
	$_ips___x_retval = '';
...
<div class='message error'>
	...
	<ul>
		".$this->__f__a62dcc43936cc63ad5f09c26b233caf5($general_errors,$data,$inline_errors,$time_select,$custom_fields)."	</ul>
</div>
<br />
") : ("")) . "<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register", 'public','' ), "", "" ) . "\" method=\"post\" name=\"REG\" id='register'>
	...
	<div id='register_form' class='block_wrap left'>
			...
			<ul>
				...
				<li class='field'>
					...
					<select id='timezone' class='input_select' name='time_offset'>
						".$this->__f__f9cf080479b4df42b72b561193fe3598($general_errors,$data,$inline_errors,$time_select,$custom_fields)."					</select>
				</li>
				<li class='field checkbox'>
		...
		" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<fieldset class='" .  IPSLib::next( $this->registry->templateStriping["register"] ) . "'>
			...
			<ul>
			" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
				".$this->__f__957339ab248ed52526f9ef782fb9fcec($general_errors,$data,$inline_errors,$time_select,$custom_fields)."			") : ("")) . "
			
			" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
				".$this->__f__17ae7ba67db6d9eaaf431532e2da703d($general_errors,$data,$inline_errors,$time_select,$custom_fields)."			") : ("")) . "
			<!--IBF.MODULES.EXTRA-->
		</fieldset>") : ("")) . "
		{$data['qandaHTML']}
		{$data['captchaHTML']}
...
function __f__a62dcc43936cc63ad5f09c26b233caf5($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
...
function __f__f9cf080479b4df42b72b561193fe3598($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
...
function __f__957339ab248ed52526f9ef782fb9fcec($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
	foreach( $custom_fields['required'] as $_field )
	{
...
function __f__17ae7ba67db6d9eaaf431532e2da703d($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array())
{
	$_ips___x_retval = '';
	foreach( $custom_fields['optional'] as $_field )
	{
