...
<!-- NEW ROW--><tr class='{$this->row_class}'>
	<th class='view_week' scope='row'>
		<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$this->request['_cal_id']}&amp;do=showweek&amp;week=$week", 'public','' ), "", "" ) . "\" title=\"{$this->lang->words['view_this_week']}\"><img src=\"{$this->settings['img_url']}/next.png\" alt='{$this->lang->words['icon']}' /></a>
	</th>";
return $IPBHTML;
}
...
<div class='post_block " . (($event['event_approved']==0) ? ("moderated") : ("")) . " id='event_id_{$event['event_id']}'>
	<div class='post_wrap'>
		...
		<div class='author_info'>
			...
			<!--{$post['author']['warn_text']} {$post['author']['warn_minus']}{$post['author']['warn_add']}-->
		</div>
		<div class='post_body'>
...
<div id='calendar_list' class='general_box'>
	...
	<ol>
		".$this->__f__1cafb2f51314941de9058f10be0b242e($calendars,$date,$month,$year,$prev,$next,$cal_id)."	</ol>
	") : ("")) . "
	<p>
...
<div id='current_calendar'>
	<div class='topic_controls'>
		<ul class='pagination'>
			<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$cal_id}&amp;do=showweek&amp;week={$prev['0']}", 'public','' ), "", "" ) . "\" title=\"{$prev['month_name']} {$prev['year_id']}\">&larr; {$this->lang->words['week_previous']}</a></li>
			<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;cal_id={$cal_id}&amp;do=showweek&amp;week={$next['0']}", 'public','' ), "", "" ) . "\" title=\"{$next['month_name']} {$next['year_id']}\">{$this->lang->words['week_next']} &rarr;</a></li>
		</ul>
...
function __f__1cafb2f51314941de9058f10be0b242e($calendars, $date="",$month="",$year="",$prev="",$next="", $cal_id=1)
{
	$_ips___x_retval = '';
...
<div class=\"tablepad\">
	<ul>
	".$this->__f__229fcaf5036b9cb618db89d67b69c218($rows)."	</ul>
</div>";
return $IPBHTML;
}


function __f__229fcaf5036b9cb618db89d67b69c218($rows)
{
	$_ips___x_retval = '';
	foreach( $rows as $r )
	{
...
<div id='calendar_list' class='general_box'>
	...
	<p><strong>{$this->lang->words['select_calendar']}</strong></p>
	<ol>
		".$this->__f__10e803bcc2bf1df7e18933dd9cc843f8($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."	</ol>
	") : ("")) . "
...
<div id='current_calendar'>
	...
	<table id='calendar_table' class='ipb_table' summary=\"{$this->lang->words['calendar_for']} $month $year\">
		...
		<tr class='header'>
			...
			".$this->__f__2d9645e300df4976717d2d8f861d4865($calendars,$month,$year,$prev,$next,$cal_jump,$cal_id,$day_words)."			<!--IBF.DAYS_CONTENT-->
		</tr>
	</table>
...
function __f__10e803bcc2bf1df7e18933dd9cc843f8($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
	foreach( $calendars as $cid => $cal )
	{
...
function __f__2d9645e300df4976717d2d8f861d4865($calendars, $month="",$year="",$prev="",$next="",$cal_jump="",$cal_id="",$day_words="")
{
	$_ips___x_retval = '';
...
<table class='mini_cal'>
	...
	".$this->__f__376ad1e62926b98d829f55e6871bf3ab($month,$mid,$year,$events,$day_words)."	</tr>
	{$events}
</table>";
return $IPBHTML;
}
